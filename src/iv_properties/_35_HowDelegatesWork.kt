...
class EffectiveDate<R> : ReadWriteProperty<R, MyDate> {
    ...
    operator override fun getValue(thisRef: R, property: KProperty<*>): MyDate = timeInMillis?.toDate() ?: throw NullPointerException("Property ${property.name} not initialized!")
